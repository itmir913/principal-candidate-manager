...
const SCORE_EXAMPLES = {
  NUMERIC_UPPER: {
    ...
    rowDescs: [
      ...
      '봉사시간이 0시간 이상 30시간 미만이면 0점 (0시간 미만이면 오류)',
    ],
  },
  NUMERIC_UPPER_COMPOSITE: {
    ...
    rowDescs: [
      ...
      '한국대 자연계열 모집단위에서 봉사시간이 0시간 이상 30시간 미만이면 0점 (0시간 미만이면 오류)',
    ],
  },
  NUMERIC_LOWER: {
  ...
  CATEGORY_SUM_COMPOSITE: {
    ...
    rowDescs: [
      ...
      "한국대 자연계열 모집단위에서 '모범상' 해당 시 3점 합산",
      "한국대 자연계열 모집단위에서 '동아리 임원진' 해당 시 2점 합산",
      "어떤 범주에도 해당하지 않으면 0점",
    ],
  },
}
