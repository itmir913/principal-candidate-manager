...
export const getBaseDataList = (id, page = 1, perPage = 50, studentType = 'enrolled') =>
  axios.get(`/api/areas/${id}/base-data/list`, { params: { page, per_page: perPage, student_type: studentType } }).then(r => r.data)
