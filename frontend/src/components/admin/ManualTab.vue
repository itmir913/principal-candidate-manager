...
const roundGuides = [
  ...
  },
  {
    ...
    items: [
      ...
      '학과명은 예외로 마감 후에도 고칠 수 있습니다. 점수 산출에 쓰이지 않고 명단 관리용이기 때문입니다. [라운드] 탭의 지원자·결과 표에서 학과명을 눌러 수정하세요. 담임교사도 자기 반 학생의 학과명을 고칠 수 있고, 수정 내역은 감사 기록에 전후 값이 남습니다. 대학·모집단위는 마감 후 바꿀 수 없습니다.',
    ],
