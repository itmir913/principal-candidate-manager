...
fn build_router(state: AppState) -> Router {
    ...
    let admin_routes = Router::new()
        ...
        .route("/universities/settings/template", get(handlers::universities::settings_template))
        .route("/universities/settings/export", get(handlers::universities::settings_export))
        .route("/universities/settings/preview", post(handlers::universities::settings_preview))
        .route("/universities/settings/import", post(handlers::universities::settings_import))
